...
like dead hardware. Ctrl-D after the copy reloads it.
    ...
    python run_on_board.py 1_selftest_part1.py
    python run_on_board.py 2_emulate.py --timeout 180 --until "APDUs served"
...
def main():
    ...
    if not port:
        ...
        return 1
    if not os.path.exists(os.path.join(drive, "lib", "pn7150.mpy")) \
            and not os.path.exists(os.path.join(drive, "lib", "pn7150.py")):
        print("!! no pn7150 in %s/lib -- copy pn7150.mpy there first." % drive)
        return 1
